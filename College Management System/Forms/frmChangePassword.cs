...
namespace College_Management_System
{
    ...
    {       
        ...
        {
            if (chkShowPasswordold.Checked == true)
            {
                txtOldPassword.UseSystemPasswordChar = false;
            }
            if (chkShowPasswordold.Checked == false)
            {
                txtOldPassword.UseSystemPasswordChar = true;
            }
        }

        private void chkShowPasswordnew_CheckedChanged(object sender, EventArgs e)
        {
            if (chkShowPasswordnew.Checked == true)
            {
                txtNewPassword.UseSystemPasswordChar = false;
                txtConfirmPassword.UseSystemPasswordChar = false;
            }
            if (chkShowPasswordnew.Checked == false)
            {
