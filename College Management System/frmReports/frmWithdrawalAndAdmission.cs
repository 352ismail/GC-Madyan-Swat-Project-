...
{
    public partial class frmWithdrawalAndAdmission : Form
    {
        ...
        public frmWithdrawalAndAdmission()
        {
            InitializeComponent();
        }

        private void frmWithdrawalAndAdmission_Load(object sender, EventArgs e)
        {
            AutocompleClassName();
        }
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Reports.rptWithdrawalAndAdmission rpt = new Reports.rptWithdrawalAndAdmission();
                //The report you created.
                SqlConnection myConnection = default(SqlConnection);
                SqlCommand MyCommand = new SqlCommand();
                SqlDataAdapter myDA = new SqlDataAdapter();
                DataSets.dstAdmissionAndWithdrawal myDS = new DataSets.dstAdmissionAndWithdrawal();
                //The DataSet you created.

                myConnection = new SqlConnection(cs.DBConn);
                MyCommand.Connection = myConnection;
                MyCommand.CommandText = "Select * FROm Student INNER JOIN Department ON Student .DepartmentId = Department.DepartmentId INNER JOIN Session ON Session.SessionId = Student.SessionId INNER JOin StudentRegistration ON StudentRegistration.StudentId = Student.StudentId WHere Department.ClassName = '"+cmbClassName.Text.Trim()+"' AND Department.FacultyName = '"+cmbFaculty.Text.Trim()+"' AND Session.Description = '"+cmbSession.Text.Trim()+"'";
                MyCommand.CommandType = CommandType.Text;
                myDA.SelectCommand = MyCommand;
                myDA.Fill(myDS, "AdmissoinAndWithdrawal");
